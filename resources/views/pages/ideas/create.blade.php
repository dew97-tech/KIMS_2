...
<div class="container">
    <h2>New Idea</h2>
    <br>
    <form class='form-horizontal' method="POST" action="{{ route('ideas.store') }}" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-12">
                <div class="form-group form-inline">
                    <label>Type</label>
                    <select name="type" class="form-control selectpicker ml-4" onchange="makeReadOnly(this.value);" required>
            ...
            <div class="col-6">
                <div class="form-group form-inline">
                    <label>Input</label>
                    <select name="option_one" id="input" class="form-control selectpicker ml-4" disabled>
            ...
            <div class="col-6">
                <div class="form-group form-inline">
                    ...
                    <select name="option_two" id="product" class="form-control selectpicker ml-4" disabled>
                        <option value="">Not Selected</option>
            ...
            <div class="col-6">
                <div class="form-group">
                    <label>Image</label>
                    <input name="image" class="form-control" id="photo" style="display: none;" type="text" value="">
            ...
            <div class="col-12">
                ...
                <textarea class="form-control" name="description" id="description" rows="4" cols="50" placeholder="Enter Description"></textarea>
            </div>
        </div>
